...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_v1(2) = 2;
    acadodata_v1(3) = 3;
    DiscretizedDifferentialEquation acadodata_f1(1);
    acadodata_f1 << next(x1) == (2.00000000000000000000e+00*x2+x1);
    acadodata_f1 << next(x2) == (2.00000000000000000000e+00*u-x2);

    Grid grid_acadodata_v1(acadodata_v1);
    OCP ocp1(grid_acadodata_v1);
    ocp1.minimizeLagrangeTerm((pow((-4.00000000000000000000e+00+x1),2.00000000000000000000e+00)+pow(u,2.00000000000000000000e+00)+pow(x2,2.00000000000000000000e+00)));
