function CTdoubleIntMPCeqNoTerm
...
% f1 = figure(1); hold on
set(0, 'currentfigure', 2);  %# for figures
...
%     f1 = figure(1);
    ...
    ax11 = subplot(4,2,[2 4 6]); grid on; hold on;
...
ax12 = subplot(4,2,[7 8]); grid on; hold on; yyaxis right
stairs(t,u);
legend('Terminal Constraints','Free Constraints')
